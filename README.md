...
- The dataset consists of seven distinct classes of data, which include drunk driving, driver assault, drowsy driving, cell phone manipulation, object finding, vehicle manipulation, and normal vehicle operation. Among these classes, the "normal" category represents instances of typical, non-aberrant vehicle operation. 
...
## If you want to implement the application, please refer to the reference file code
